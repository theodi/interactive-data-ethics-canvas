...
<li>Inequitable access to data literacy and capacity building opportunities.</li>
</ul>
...
<ul class="card-list">
  <li>
    <h3>
      <a href="https://theodi.org/project/the-value-of-data-sharing-in-the-private-sector/" target="_blank"
  ...
  <li>
    <h3>
      <a href="https://theodi.github.io/staging.learndata.info/def3" target="_blank"
        >eLearning: Maximising reuse of data through licensing and sharing</a>
    </h3>
    <p>
      This module introduces the key role of data sharing agreements and data licenses as ways to safely share data, maximise its reuse and reduce inequitable outcomes from when data is not shared.
    </p>
  </li>
  <li>
    <h3>
      <a href="https://theodi.org/article/publishers-guide-to-open-data-licensing/" target="_blank"
        >Guide: Publisher’s Guide to Open Data Licensing</a>
    </h3>
    <p>
