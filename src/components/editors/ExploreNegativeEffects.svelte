...
<BooleanAndTextarea question={ $t('areas:' + id + '.questions.1') } bind:content={ $canvasState.blobs[ref].content[1] } />
<BooleanAndTextarea question={ $t('areas:' + id + '.questions.2') } bind:content={ $canvasState.blobs[ref].content[2] } />
